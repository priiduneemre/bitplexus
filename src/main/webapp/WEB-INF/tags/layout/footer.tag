		...
		<div id="footer" class="footer-bg footer-color">
			<div class="container">
				<div class="row valign-center">
					<div class="col-md-1">
						<a href="" title="Bitplexus">
							<img alt="Bitplexus" id="footer-icon" src="static/img/icon_64x64.png"/>
						</a>
					</div>
					<div class="col-md-3 col-lg-2 text-center">
						<span>&copy; 2015 Bitplexus, LLC<br>Tallinn, Estonia</span>
					</div>
					...
					<div class="col-md-3 col-lg-2 text-right">
						...
						<a class="btn btn-xs btn-social-icon btn-linkedin" href="https://linkedin.com/in/priidu" target="_blank">
