...
/*File description: DML statements for populating the application's database with seed data (optimized for PostgreSQL 9.4.4).*/
/*Author:           Priidu Neemre (priidu@neemre.com)*/
/*Last modified:    2015-07-13 15:17:27*/
...
ALTER TABLE IF EXISTS transaction ENABLE TRIGGER tr_transaction_fee_check;
...
ALTER SEQUENCE IF EXISTS seq_transaction_transaction_id RESTART WITH 17;
