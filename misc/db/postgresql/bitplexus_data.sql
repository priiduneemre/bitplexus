...
ALTER TABLE IF EXISTS transactions DISABLE TRIGGER tr_transactions_fee_check;
...
ALTER TABLE IF EXISTS transactions ENABLE TRIGGER tr_transactions_fee_check;
