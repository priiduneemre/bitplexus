...
INSERT INTO currency (currency_id, name, abbreviation, symbol, block_time, available_supply, website_url, launched_on, created_at, created_by) VALUES (1, 'Bitcoin', 'BTC', '฿', 600, f_bitcoin_calc_supply(359529), 'https://bitcoin.org/', '2009-01-03', '2015-03-19 23:48:41', 3);
INSERT INTO currency (currency_id, name, abbreviation, symbol, block_time, available_supply, website_url, launched_on, created_at, created_by) VALUES (2, 'Litecoin', 'LTC', 'Ł', 150, f_litecoin_calc_supply(792946), 'https://litecoin.org/', '2011-10-08', '2015-03-20 00:34:20', 3);
